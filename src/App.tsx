...
import { createProjectCode, hasSupabaseConfig, saveCloudProject } from "./lib/supabase";

export default function App() {
  const { project, currentShot, select, move, setStatus, replace, progress } = useProjectData();
  const [projectCode] = useState(() => localStorage.getItem("director-shot-project-code") || createProjectCode());
  ...
  return <div className="app-shell">
    ...
    <section className="sync-bar">
      ...
      <a href="?mode=glasses&project=DEMO" target="_blank">開啟眼鏡 Demo</a>
    </section>
